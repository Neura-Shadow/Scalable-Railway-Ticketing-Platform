...
func TestReservationMapsTypedStoreFailuresToSafeSentinels(t *testing.T) {
	tests := []struct{ err, want error }{{bookingpostgres.ErrInsufficientInventory, httpapi.ErrConflict}, {bookingpostgres.ErrIdempotencyConflict, httpapi.ErrConflict}, {bookingpostgres.ErrInvalidState, httpapi.ErrConflict}, {bookingpostgres.ErrNotFound, httpapi.ErrNotFound}, {bookingpostgres.ErrInvalidArgument, httpapi.ErrInvalidInput}, {errors.New("database secret"), httpapi.ErrUnavailable}}
