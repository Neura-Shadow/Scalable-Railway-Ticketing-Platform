...
func TestCatalogRouterRefreshesStaleRouteWithoutReadingAConnectionString(t *testing.T) {
	...
	db := &catalogDB{rows: []catalogRow{
		{values: []any{"physical-shard-0", int64(3), "postgres", "physical-shard-0", int32(1), physical.SupportedSchemaVersion, true, true, "healthy", "active", int32(1)}},
		{values: []any{"physical-shard-1", int64(4), "postgres", "physical-shard-1", int32(1), physical.SupportedSchemaVersion, true, true, "healthy", "active", int32(1)}},
	}}
...
func TestCatalogRouterMetricsUseBoundedOutcomeReasons(t *testing.T) {
	...
	valid := []any{
		...
		int32(1), physical.SupportedSchemaVersion, true, true, "healthy", "active", int32(1),
	}
	tests := []struct {
		name        string
		values      []any
		...
		{name: "protocol", values: []any{
			"physical-shard-0", int64(3), "postgres", "physical-shard-0",
			int32(2), physical.SupportedSchemaVersion, true, true, "healthy", "active", int32(1),
